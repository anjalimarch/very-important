...
import org.openqa.selenium.support.ui.Select;
	...
	public class WeBuyashi {
		...
		public static void main(String args[]){
			...
			List<WebElement> selects =driver.findElements(By.xpath("//select[@class='buybasket']"));
			...
			System.out.println("***"+secondCol.size());
			for(int i=0;i<secondCol.size()-2;i++){
				...
				s.selectByVisibleText(productQuatityToBeAdded.get(key));
				 ...
				 selects =driver.findElements(By.xpath("//select[@class='buybasket']"));
			}
